	...
	tests := []struct {
	...
	}{
		{
			...
			b: []byte{
				...
				0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x01, 0xff, 0x84, 0x00, 0x00, 0x00, 0x2a, 0xff, 0x83, 0x03,
				0x01, 0x01, 0x06, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x01, 0xff, 0x84, 0x00, 0x01, 0x02, 0x01,
				0x05, 0x4d, 0x54, 0x79, 0x70, 0x65, 0x01, 0x06, 0x00, 0x01, 0x06, 0x53, 0x6f, 0x75, 0x72, 0x63,
				0x65, 0x01, 0xff, 0x86, 0x00, 0x00, 0x00, 0x10, 0xff, 0x85, 0x06, 0x01, 0x01, 0x04, 0x55, 0x55,
				0x49, 0x44, 0x01, 0xff, 0x86, 0x00, 0x00, 0x00, 0x05, 0xff, 0x82, 0x01, 0x00, 0x00,
			},
		},
		{
			name: "Discover",
			...
			b: []byte{
				...
				0x05, 0x4d, 0x54, 0x79, 0x70, 0x65, 0x01, 0x06, 0x00, 0x01, 0x06, 0x53, 0x6f, 0x75, 0x72, 0x63,
				0x65, 0x01, 0xff, 0x86, 0x00, 0x00, 0x00, 0x10, 0xff, 0x85, 0x06, 0x01, 0x01, 0x04, 0x55, 0x55,
				0x49, 0x44, 0x01, 0xff, 0x86, 0x00, 0x00, 0x00, 0x17, 0xff, 0x82, 0x01, 0x02, 0x10, 0xef, 0xda,
				0xed, 0xf2, 0x44, 0x85, 0x49, 0x9f, 0x8a, 0x68, 0x3e, 0xea, 0x08, 0x8f, 0xa7, 0xae, 0x00, 0x00,
			},
		},
	}
...
func testProtocolUnmarshal(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			b: &payload{
				[]byte{
					0x54, 0x79, 0x70, 0x65, 0x44, 0x69, 0x73, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x30, 0x30, 0x30, 0x30,
