...
const (
	...
	CommandAsyncAck
	// CommandAsyncFail is used to signal failure on an async command. Message should be consulted to see the reason.
	CommandAsyncFail
	// CommandAsyncSuccess is used to signal success on an async command
	CommandAsyncSuccess
	// CommandError is used to signal a failure with executing the command. Message should be consulted to see the reason.
	CommandError
)
